...
class CourseClass:
    def __init__(self,root):
        ...
        '''****Title****'''
        title=Label(self.root,text="Manage Course Details", font=("Bookman Old Style",20,"bold"),bg="skyblue",fg="black").place(x=10,y=15,width=1180,height=35)
        ...
        self.CourseTable.heading("description", text="Descripton")
